  ...
  <div>
    ...
    <div class="py-8">
      <ul class="list-disc list-inside">
        ...
        <li>August at Bullocksteads Sports Ground, Kingston Park, Newcastle</li>
        <li>State of the art 3G facilities</li>
        <li>Cup and Trophy event</li>
      </ul>
    </div>

    <p class="pb-8">To register, simply tap the button below, complete all fields and make payment.</p>
...
export default {
  ...
  data: () => ({
    formActive: false,
    form: {
      emailAddress: 'me@liam-potter.co.uk',
      clubName: 'Gosforth Bohemians',
      teamName: 'Under 12s',
      ageGroup: 'under-12',
      coachName: 'Liam Potter',
      contactNumber: '07900476893',
      acceptedCoachQualificationAgreement: true,
      acceptedOrganiserDecisionAgreement: true,
    },
    // form: {
    //   emailAddress: null,
    //   clubName: null,
